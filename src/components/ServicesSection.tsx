...
import { Home, Pill, Brain, Dumbbell, UtensilsCrossed, ArrowRight } from "lucide-react";
...
const services = [
  {
    icon: Home,
    title: "Home Nursing",
    description: "Comprehensive nursing care in the comfort of your home, supervised by medical professionals.",
    color: "bg-secondary",
  },
  {
    icon: Pill,
  ...
  },
  {
    ...
    description: "Custom meal plans designed by medical nutritionists based on individual health needs.",
    color: "bg-primary",
  },
];
      ...
      <div className="container-custom relative z-10">
        ...
        >
          ...
          <p className="text-primary-foreground/80 text-lg">
            From medical care to holistic wellness, we provide a complete range of services 
          ...
          {services.map((service, index) => (
            ...
            >
              <div className="bg-card rounded-2xl p-8 h-full card-hover transition-all duration-300">
                <div className={`w-14 h-14 rounded-2xl ${service.color} flex items-center justify-center mb-6 transition-transform group-hover:scale-110`}>
